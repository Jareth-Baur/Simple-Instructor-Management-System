...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Instructor Management System - Login Page");
        setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        setResizable(false);

        rootPanel.setBackground(new java.awt.Color(153, 255, 204));
    ...
    private void loginButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginButtonMouseClicked
        ...
        if ("user".equals(username) && "user".equals(password)) {
            JOptionPane.showMessageDialog(null, "Login Successful!\nWelcome back, " + username + "! You are now logged in to the Instructor Management System.\nExplore the system's features and manage instructor records efficiently.\nThank you for using our system!", "Success", JOptionPane.INFORMATION_MESSAGE);
